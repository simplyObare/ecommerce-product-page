...
const CartTab = () => {
  ...
  return (
    <div className=" max-w-[350px] sm:w-[350px] md:w-[350px] min-w-[315px] h-[250px] bg-white sm:shadow-2xl md:shadow-2xl lg:shadow-2xl shadow-none sm:shadow-orange-default/45 md:shadow-orange-default/45 lg:shadow-orange-default/45 sm:border-white md:border-white lg:border-white rounded-xl absolute sm:top-16 md:top-16 lg:top-16 top-[100px] sm:-right-24 md:-right-24 lg:-right-24 right-1">
